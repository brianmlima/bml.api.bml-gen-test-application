 ...
 *
 * <p>Error types for field validation
 *
...
@JsonDeserialize(converter = FieldValidationErrorType.Converters.ToEnum.class)
@JsonSerialize(converter = FieldValidationErrorType.Converters.ToString.class)
public enum FieldValidationErrorType {
  ...
  private static final Map<String, FieldValidationErrorType> API_VALUE__MAP;

  static {
    // Initialize API_VALUE__MAP to support lookup based on original enum value
    Map<String, FieldValidationErrorType> tmp = new LinkedHashMap<>();
    // Add all values and original strings to tmp
    for (FieldValidationErrorType e : values()) {
  ...
  FieldValidationErrorType(final String apiValue, final String description) {
    this.apiValue = apiValue;
    this.description = description;
  }

  public static final FieldValidationErrorType fromApiValue(final String apiValue) {
  ...
  public static class Converters {
    ...
    public static class ToEnum implements Converter<String, FieldValidationErrorType> {
      @Override
      public FieldValidationErrorType convert(final String apiValue) {
        return FieldValidationErrorType.fromApiValue(apiValue);
      }
      ...
      public JavaType getOutputType(final TypeFactory typeFactory) {
        return typeFactory.constructType(FieldValidationErrorType.class);
      }
    }

    public static class ToString implements Converter<FieldValidationErrorType, String> {
      @Override
      public String convert(final FieldValidationErrorType enumValue) {
